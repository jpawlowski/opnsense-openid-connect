...
| [JSON Web Algorithms (RFC 7518)](https://www.rfc-editor.org/rfc/rfc7518.html) | RS256/384/512, PS256/384/512 and ES256/384/512 JWS verification with public RSA and EC JWKs | Implemented | ✅ verified | Verified only for the named asymmetric JWS verification subset; HMAC, unsecured JWS, JWE and all other algorithm families are outside this claim. |
