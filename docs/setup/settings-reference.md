...
uses the current unsaved client values for an authenticated PAR check when
applicable; it also works without client credentials. Connection health becomes
