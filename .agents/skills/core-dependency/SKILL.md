...
description: Add or change a dependency on OPNsense core behavior, including authentication classes, sessions, dispatch, configd, ACLs, or the login page. Use when plugin code starts relying on a core interface that can change independently.
---
